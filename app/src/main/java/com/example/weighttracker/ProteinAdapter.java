...
public class ProteinAdapter extends RecyclerView.Adapter<ProteinAdapter.ViewHolder> {
    ...
    public ProteinAdapter(List<ThucPham> thucPhams, DietActivity context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View canxiView =
                inflater.inflate(R.layout.item_protein, parent, false);
...
//            textDescription = itemView.findViewById(R.id.txtCanxiDescription);
            textName = itemView.findViewById(R.id.txtProtein);
            imageProtein = itemView.findViewById(R.id.imgProtein);
        }
    }
